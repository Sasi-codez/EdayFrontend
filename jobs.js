document.addEventListener('DOMContentLoaded', function() {
    ...
    async function handleUpload(event) {
        ...
        try {
            ...
            const response = await fetch('https://backendsupport-yjus.onrender.com/resume/upload', {
                method: 'POST',
                body: formData
            });
    ...
    async function handleFindJobs() {
        ...
        try {
            ...
            const response = await fetch('https://backendsupport-yjus.onrender.com/fetchJobs', {
                method: 'POST',
